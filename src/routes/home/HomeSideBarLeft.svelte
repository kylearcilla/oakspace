...
<div class="nav-menu">
    <div>
        ...
        <div class={`nav-menu__tabs ${$themeState.isDarkTheme ? "nav-menu__tabs--dark-theme" : ""} nav-menu__tabs--${$themeState.title === "Dark Mode" ? "dark-mode" : ($themeState.title === "Light Mode" ? "light-mode" : "simple-styling")}`}>
            <button on:click={() => openModal(ModalType.Stats)} class="nav-menu-tab nav-menu-tab--stats tool-tip-container">
                <!-- <span class="tool-tip-text tool-tip-text--left">Stats</span> -->
                <i class="fa-solid fa-chart-line nav-menu-tab__icon"></i>
            </button>
            <button on:click={() => openModal(ModalType.Journal)} class="nav-menu-tab nav-menu-tab--journal tool-tip-container">
                <!-- <span class="tool-tip-text tool-tip-text--left">Stats</span> -->
                <i class="fa-solid fa-fire nav-menu-tab__icon"></i>
            </button>
            <button on:click={() => openModal(ModalType.Youtube)} class="nav-menu-tab nav-menu-tab--vid tool-tip-container">
                <!-- <span class="tool-tip-text tool-tip-text--left">Youtube</span> -->
                <i class="fa-brands fa-youtube nav-menu-tab__icon"></i>
            </button>
            <button on:click={() => openModal(ModalType.Music)} class="nav-menu-tab nav-menu-tab--music tool-tip-container">
                <!-- <span class="tool-tip-text tool-tip-text--left">Music</span> -->
                <i class="fa-solid fa-music"></i>
            </button>
            <button on:click={() => openModal(ModalType.Appearance)} class={"nav-menu-tab nav-menu-tab--appearance tool-tip-container"}>
